...
namespace AnsonGlue.Equipment.Motion.Business.AbstractClass
{
    /// <summary>
    ///     不同运动卡的统一函数
    /// </summary>
    public abstract class CMotionBase
    {
        ...
        ///     /二维比较参数设置结构体
        /// </summary>
        public struct STRUCT_DD_COMPARE_PRM
        {
            //固高灵猴通用
            public short m_nEncx;
            public short m_nEncy;
            public short m_nSource;
            public short m_nOutputType;
            public short m_nStartLevel;
            public short m_nTime;
            public short m_nMaxerr;
            public short m_nThreshold;

            //灵猴多余的
            public short m_pluseCountNum;
            public short m_spacetime;
        }
        ...
        ///     数字输入口数
        /// </summary>
        public short m_diNum;

        /// <summary>
        ///     数字输出口数
        /// </summary>
        public short m_doNum;
        ...
        /// <returns></returns>
        public abstract short GetExtendDi(short nCardNum, short address, out ushort diStatus);
        ...
        /// <returns></returns>
        public abstract short SetLineOrdi(short nCardNum, short crd, short nDim, double synVelMax, double synAccMax,
        ...
        /// <param name="lenght">前瞻缓存区大小</param>
        /// <returns></returns>
        public abstract short InitLookAhead(short nCardNum, short crd, short fifo, double T, double accMax,
            short lenght);
        ...
        /// <param name="dCenterX">圆弧插补圆心坐标X</param>
        /// <param name="dCenterY">圆弧插补圆心坐标Y</param>
        ...
        /// <returns></returns>
        public abstract short ArcXyc(short nCardNum, short crd, int x, int y, double dCenterX, double dCenterY, short circleDir,
        ...
        /// <param name="fifo">插补缓存区号。正整数，取值范围：[0, 1]，默认值为：0。</param>
        /// <returns></returns>
        public abstract short BufDelay(short nCardNum, short crd, ushort delayTime, short fifo = 0);
