...
namespace AnsonGlue.Equipment.Vision.AbstractClass
{
    public abstract class CVisionAbs
    {
        /// <summary>
        ///     消息函数规则
        /// </summary>
        ...
        protected CVisionAbs(CCmtAbs oCmtAbs)
        {
            m_oCmtAbs = oCmtAbs;
            m_bIsOpen = false;
        }

        public abstract bool SendMsgToVision(string strMsg);
        ...
        /// <returns></returns>
        public bool InitVision(DELEGATE_MSG fun)
        {
            //初始化通讯类
